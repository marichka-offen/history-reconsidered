<template>
  <div>
    ...
    <h3>Pipers</h3>
    <blockquote>
      'With us any captain may keep a piper in his company, and maintain him
      too, for no pay is allowed him, perhaps just as much as he deserveth.”
    </blockquote>
    <h6>– Pallas Armata, by Sir James Turner, 1683</h6>
    <h3>Recruitment</h3>
    <blockquote>
      “Whereas the Scottish regiment under the command of George, Lord Douglas,
      did, in obedience to our orders, come over readily and cheerfully to our
      service, wee are resolved to intertain and recruite the same although we
      think fitt to raise the greatest part of the recruits here in this kingdom
      because of the leavies now making in Scotland for our service there yet ,
      seeing the regiment is a Scottish regiment, wee have thought fitt to raise
      for it two hundreth men in that our ancient kingdom of Scotland”
    </blockquote>
    <h6>Letter from Charles II to the Privy Council, September 1666</h6>
    <p>
      The above quote makes it clear that at least one occasion, and perhaps
      more, soldiers from England were recruited to serve in the Regiment. There
      was some bias against service in the Regiment in parts of Scotland and
      England because it was considered a French Regiment and the officers were,
    ...
    <h3>Chronology of the Regiment to 1688</h3>
    <p>
    ...
    <h3>Gustavus II Adolphus, King of Sweden, Finland and Livonia</h3>
    <p>
      <b>August-September 1630</b> Capture and defense of Rugenvald castle.
      Relieved and reinforced by Hepburn’s Regiment.
    </p>
    <blockquote>
    ...
    <blockquote>
      ...
      service to be set upon, the Scottish have always had the honor and the
      danger to be the first men that are put to such a business.”
    </blockquote>
    ...
    <blockquote>
      “Sir John Hepburn being made Colonel of the Briggad, his Regiment, Colonel
      Lumsedells, Stragates and ours, made up the Scots Brigad.”
    </blockquote>
    <h6>– Robert Monro</h6>
    <p>
    ...
    <blockquote>
      “I with my partie, did lie to our poste, as betwixt the devil and the
      deepe sea for sometimes our owne cannon would light short and grase over
    ...
    <blockquote>
      “They are a strong, hardy race, contenting themselves with little food, if
      they have no bread they eat roots and carrots; in case of necessity they
      are bale to walk twenty German miles in a day; they have besides muskets,
    ...
    <p>
      <b>1635</b>Lorraine Colonel Sir John Hepburn commands 8,000 man force that
      includes Le Regiment De Hebron
    </p>
    <blockquote>
      “The Scots fought for eight days, almost without intermission leaving the
      ways by which they retreated more remarkable by the blood of their enemies
      than their own”
    </blockquote>
    ...
    <blockquote>“To the best Soldier of the Age”</blockquote>
    <h6>Inscription on Sir John Hepburn’s tomb at Toul Cathederal</h6>
    <p>
    ...
    <h4 class="center">Dumbartons Drums</h4>
    <p class="center">
      <i>
        Chorus
    ...
    <blockquote>
      “You may take all duties of a Souldier to be, as the Lacedaemonians did,
      to be three. First, to give exact and perfect obedience to all the lawful
      commands of Superiours. Secondly to endure the fatigue, travel, and
      discommodites of War, whether it be in Marching, or working at Trenches,
      Approaches Sieges, hunger, thirst and cold with an exemplary patience.
      Thirdly, In time of Battell, Skirmish or Assault, to resolve either to
      overcome, or dye. But Reader, do not seek all these in every souldier, do
      not seek any of these exactly in any souldier, for you will not find them;
      let it be enough if they have some of them in some degree, though not in
      perfection.”
    </blockquote>
    <h6>– Pallas Armata, by Sir James Turner, 1683</h6>
    <blockquote>
      “After this landed the valorous Major Hackett with the renowned regiment
      of the Earl of Dumbarton; all of them men of approved valour, fame having
      echoed the sound of their glorious actions and achievements in France and
      other nations; having left behind them a report of their glorious
      ...
      regiment more and more increased the resolution and courage of the
    ...
    <ol>
      ...
      <li>
        Monro, Robert, His Expedition with the Worthy Scots Regiment called
        MacKeys (London, 1637)
      </li>
    ...
    <ul>
      ...
      <li>
        Jamison, Ted, George Monck and the Restoration: Victor Without Bloodshed
        ( Texas, 1975)
      </li>
      <li>Keeble, N.H., The Restoration, England in the 1660s ( UK, 2002)</li>
      <li>
        Miller, John, After the Civil Wars, English Politics and Government in
        the Reign of Charles II ( Essex, 2000)
      </li>
      <li>Miller, John, James II, A Study in Kingship ( London, 1999)</li>
      <li>
        Monro, Robert, His Expedition with the Worthy Scots Regiment called
        MacKeys ( London, 1637)
      </li>
