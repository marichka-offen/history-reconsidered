<template>
  <div>
    ...
    <div class="image">
      <img class="image--sm" src="@/assets/images/IrishHistory/flag.jpg" alt="Regimental colors" />
      <i>
        <h5>
          The regimental colors remain a mystery, but some clues exist in the
          following warrant:
        </h5>
      </i>
    </div>
    <blockquote>
      Yellow Taffey and Crimson for 12 Coulours for a Regiment of Foot and that
      you cause Our badges to be painted and guilded thereon, and that you
      deliver the same parcels of taffey at the same rate they were furnished
      for Our Regiment of Foot….and that you deliver the same to Our right and
      trusty, &c., James Duke of Ormond, Lieutenant of Our K ingdom of Ireland
    </blockquote>
    <h6>24 March 1662</h6>
    <p>
